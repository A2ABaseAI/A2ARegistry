...
def create_sample_data():
    ...
    try:
        ...
        benefits_agent = agent_service.create_agent(
            agent_data=AgentCreate(**benefits_agent_data), client_id=admin_client.id
        )
        ...
        customer_agent = agent_service.create_agent(
            agent_data=AgentCreate(**customer_agent_data), client_id=admin_client.id
        )
